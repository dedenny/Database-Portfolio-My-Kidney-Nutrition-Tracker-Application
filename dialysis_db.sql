...
CREATE TABLE IF NOT EXISTS `mydb`.`Lab_Results` (
  ...
  `Dialysis_Forms_dialysis_id` INT UNSIGNED NOT NULL,
  ...
  INDEX `fk_Lab_Results_Dialysis_Forms1_idx` (`Dialysis_Forms_dialysis_id` ASC) VISIBLE,
  CONSTRAINT `fk_Lab_Results_Patients1`
    FOREIGN KEY (`Patients_patient_id`)
    REFERENCES `mydb`.`Patients` (`patient_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Lab_Results_Dialysis_Forms1`
    FOREIGN KEY (`Dialysis_Forms_dialysis_id`)
    REFERENCES `mydb`.`Dialysis_Forms` (`dialysis_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
sodium_lab,sodium_lab_unit,dialysis_adequacy_lab,lab_results_time,Patients_patient_id,Dialysis_Forms_dialysis_id) VALUES
('1','3.5','mg/dL','3.4','mEq/L','135','mEq/L','1.2','2022-05-07 23:22:05','3','1'),
('2','5.5','mg/dL','3','mEq/L','142','mEq/L','1.7','2022-05-08 18:36:10','2','2'),
('3','6.5','mg/dL','2.8','mEq/L','146','mEq/L','1.1','2022-05-01 20:20:06','4','1'),
('4','10.5','mg/dL','6.6','mEq/L','144','mEq/L','0.6','2022-05-07 18:01:55','5','2'),
('5','7.2','mg/dL','4.5','mEq/L','134','mEq/L','2.2','2022-05-11 10:19:25','1','1');
...
INSERT INTO foods (food_id, food_name, amount, portion_unit, phosphorous_content, phosphorous_unit, sodium_content, sodium_unit, calories, calories_unit, potassium_content, potassium_unit) VALUES
('1077', 'Milk,whole'                 ,'128','grams', '251','mg', '94', 'mg', '152', 'kcal', '374', 'mg'),
('23385', 'Beef, loin, top loin steak', '284','grams', '585','mg', '128', 'mg', '423', 'kcal', '801', 'mg'),
('5746', 'Chicken, breast',            '174','grams', '419','mg',  '81', 'mg', '275', 'kcal', '597', 'mg'),
('1256', 'Yogurt, Greek, nonfat',      '156','grams', '212','mg',  '56', 'mg', '92', 'kcal', '348', 'mg'),
...
-- drop tables dialysis_forms, foods, lab_results, patients, patients_food;
